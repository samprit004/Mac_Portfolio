...
const GHFavicon = () => (
  <svg viewBox="0 0 16 16" style={{ width: 14, height: 14, fill: "#1c1c1e", flexShrink: 0 }} aria-hidden="true">
...
const SafariTabs = () => {
  ...
  return (
    <div
      ...
      style={{ background: "#d9d9d9", height: "30px" }}
    >
      {TABS.map((tab) => {
        ...
        return (
          ...
          >
            ...
            <span
              className="truncate"
              style={{ color: isActive ? "#1c1c1e" : "#555", maxWidth: "130px" }}
            >
              {tab.label}
            </span>
            {isActive && (
              <X
                size={12}
                className="ml-auto shrink-0 text-gray-400 hover:text-gray-700 hover:bg-gray-200 rounded"
              />
            )}
          </button>
        );
